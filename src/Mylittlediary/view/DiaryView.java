...
public class DiaryView extends JFrame {
	...
	private Diary diary; //valami apro pici v�ltoztat�s kell ebbe ide bele
	...
	public void hozzaad(){
		...
		for(int i = 0; i< diary.notes.size(); i++){
			if(diary.notes.get(i).getDate().equals(txtDatum.getText())){
				varninglbl.setText("Ilyened m�r van, csak m�dos�tani lehet");		
				talalat=1;
			}
		...
		if (talalat==0) {
			txtNote.setText("");
			txtDatum.setText("����.hh.nn.");
			varninglbl.setText("Hozz�adva");
		diary.addNote(uj);	
		try {
	...
	public DiaryView() {
		...
		JButton btnNewButton = new JButton("Jegyzet hozz�ad�sa");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CardLayout cl
				= (CardLayout)(getContentPane().getLayout());
			    cl.show(getContentPane(), "notepanel");
			    txtNote.setText("�rd be a jegyzeted");
			    txtDatum.setText("����.hh.nn."); //efefed
			    varninglbl.setText("");
				...
				.addGroup(gl_notePanel.createSequentialGroup()
					...
					.addGroup(gl_notePanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_notePanel.createSequentialGroup()
							...
							.addContainerGap())
						.addGroup(Alignment.TRAILING, gl_notePanel.createSequentialGroup()
							.addGap(46)
		...
		btnJegyzetek.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				model.addColumn("D�tum");
				model.addColumn("Bejegyz�s");
